...
type AdminDashboardNavigationProp = NativeStackNavigationProp<AdminStackParamList, 'Dashboard'>;
      ...
      <View style={styles.content}>
        ...
        <View style={styles.actionsContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate(SCREEN_NAMES.MANAGE_FOOD as keyof AdminStackParamList)}
          >
          ...
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => navigation.navigate(SCREEN_NAMES.ORDER_MANAGEMENT as keyof AdminStackParamList)}
          >
