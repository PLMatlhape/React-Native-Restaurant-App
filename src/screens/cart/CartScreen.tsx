...
const CartScreen: React.FC<CartScreenProps> = ({ navigation }) => {
  ...
  const handleCheckout = (): void => {
    ...
    navigation.navigate(SCREEN_NAMES.CHECKOUT as keyof CartStackParamList);
  };
  ...
  const handleRemoveItem = (cartItemId: string, itemName: string): void => {
    Alert.alert(
      'Remove Item',
  ...
  const renderCartItem: ListRenderItem<CartItemWithDetails> = ({ item }) => (
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => (navigation as any).navigate(SCREEN_NAMES.HOME)}
        >
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Cart Items */}
      <FlatList
        data={cartItems as CartItemWithDetails[]}
